...
public class Briefcase {
    ...
    private List<Double> availableValues = new ArrayList(Arrays.asList(0.01, 1.0, 5.0, 10.0, 25.0, 50.0, 75.0, 100.0, 200.0, 300.0,
    ...
    public Briefcase(){
        ...
        this.amount = assignValue(availableValues);
        this.availableValues.remove(amount);
        CASE_NUM_GEN++;
    }

    private double assignValue(List<Double> values) {
        //return values[rand]
